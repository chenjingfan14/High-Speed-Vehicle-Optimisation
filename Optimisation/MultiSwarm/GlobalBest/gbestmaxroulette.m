function GlobalBest = gbestmaxroulette(nonDomFit,parsDominated,nonDomPos)
%% Roulette wheel global best selection
% Picks global best with respect to Pareto Front particles who dominate
% most number of particles. Therefore more particles dominated = higher
% chance of being selected (ie. inner Pareto Front particles)

[dim,~] = size(nonDomFit);

num = (1:dim)';

dsort = sortrows([num,parsDominated],2);
