...
if options.Parallel
    ...
    parfor i=1:nPop
        ...
        [parProperties,allPoints,parPos(i,:),parameters,flag] = particlecreator(parPos(i,:),physicalPos(i,:),varArray,sections(i,:),options);
        ...
        parFit(i,:) = feval(costFun,parProperties,allPoints,flow,parameters,thetaBetaM,maxThetaBetaM,PrandtlMeyer,options);
        end
    end
