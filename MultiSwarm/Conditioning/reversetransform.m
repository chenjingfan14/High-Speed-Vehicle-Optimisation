function [transformedPos] = reversetransform(initialPos,cond,varArray)
%% Reverse transformation from physical properties to particle
...
%% Alterations
% From physical position to particle configuration inputs
for i = 1:dim
